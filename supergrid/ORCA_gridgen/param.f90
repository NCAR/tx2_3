...
!!----------------------------------------------------------------------
  ...
  LOGICAL, PARAMETER :: l_trop_stretch = .TRUE.
  ...
  INTEGER, PARAMETER :: &!:
       jpi    =  540+1        ,&
       jpeqt  =  226          ,&  ! From south to equator
       jpeqn  =  30           ,&  ! From equator to join
       jpnord =  166              ! From join to top
  ...
  !!      jpjm    : jpj+1  (condition de repliement nord)
  !!
